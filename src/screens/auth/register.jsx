                ...
                <form className="auth-form" onSubmit={handleRegister}>
                    ...
                    <div className="glass-input-group">
                        <input
                            ...
                            required
                        />
                        <span className="input-hint" id="username-hint">3-20 caracteres, solo letras, números y _</span>
                    </div>
                    ...
                    <div className="glass-input-group">
                        <input
                            ...
                            required
                        />
                        <span className="input-hint" id="password-hint">Mínimo 6 caracteres</span>
                    </div>
