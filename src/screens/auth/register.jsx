...
export default function Register() {
  ...
  return (
    <AuthLayout mode="register" eyebrow="Crea tu espacio" title="Empieza a escuchar a tu manera." description="Son solo unos datos. Después elegirás tus artistas favoritos para personalizar tu experiencia." footer={<button type="button" className="auth-switch" onClick={() => navigate('/login')} disabled={isLoading || Boolean(success)}>¿Ya tienes cuenta? <strong>Inicia sesión</strong></button>}>
